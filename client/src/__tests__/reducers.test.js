...
// want to ensure only the first item's quantity is updated, because
// it's _id matches the _id given to the reducer function.
// second item's purchaseQuantity should remain at 2
